-- Habilidades más solicitadas (excluyendo genéricas)
...
habilidades_tecnicas AS (
    ...
    WHERE ht.nombre_habilidad_tecnica NOT LIKE '%No especificada%'
      AND ht.nombre_habilidad_tecnica NOT LIKE '%Otra%'
...
habilidades_blandas AS (
    ...
    WHERE hb.nombre_habilidad_blanda NOT LIKE '%No especificada%'
      AND hb.nombre_habilidad_blanda NOT LIKE '%Otra%'
    GROUP BY tipo_habilidad, nombre_habilidad
)
